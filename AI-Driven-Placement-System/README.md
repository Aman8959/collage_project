# 🎓 AI Driven Placement & Career Intelligence System

AI Driven Placement & Career Intelligence System is an integrated **AI-powered platform** designed to streamline and elevate the campus placement experience for **students**, **training and placement officers (TPOs)**, and **recruiters**.
...
```bash
git clone https://github.com/your-username/AI-Driven-Placement-System.git
cd AI-Driven-Placement-System
```
